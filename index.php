      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <!----------------------------------------------------------------->
            <li class="nav-item">
              <a id="a_otziv" class="nav-link" href="#navbar-otziv" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
                <i class="fas fa-comments text-primary"></i>
                <span class="nav-link-text">Отзывы</span>
              </a>
              <div class="collapse" id="navbar-otziv">
                <ul class="nav nav-sm flex-column">
                  <li id="a1_otziv" class="nav-item">
                    <a href="<?=$realdir?>/admin/otziv" class="nav-link">Список</a>
                  </li>
                  <li id="a2_otziv" class="nav-item">
                    <a href="<?=$realdir?>/admin/addotziv" class="nav-link">Добавить</a>
                  </li>
                </ul>
              </div>
            </li>
