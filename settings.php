        ...
        <div class="card">
          ...
          <div class="card-body">
            <form method="post" id="settings">
              ...
              <div class="form-group">
                <label class="form-control-label" for="exampleFormControlInput1">Youtube</label>
                <input type="text" name="Youtube" class="form-control" id="exampleFormControlInput1" value="<?=$config['Youtube']?>">
              </div>
              <div class="form-group">
                <label class="form-control-label" for="exampleFormControlInput1">Оповещение</label>
                <input type="text" name="Notify" class="form-control" id="exampleFormControlInput1" value="<?=$config['Notify']?>">
              </div>
